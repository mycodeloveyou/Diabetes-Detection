from customtkinter import * #for window create 
from PIL import Image, ImageTk  #for image display
import pandas as pd        #for data manipulation
from sklearn.neighbors import KNeighborsClassifier #for model creation
from sklearn.metrics import accuracy_score #for model evaluation
from sklearn.model_selection import train_test_split #for data splitting

model=KNeighborsClassifier(n_neighbors=3) # create the model
data=pd.read_csv("diabetes.csv") # read the data
data.dropna() # drop the missing values
x=data.iloc[:,:-1] # split the data into x and y
y=data.iloc[:,-1] # split the data into x and y
